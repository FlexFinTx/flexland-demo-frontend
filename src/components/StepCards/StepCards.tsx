    ...
    <div className="level">
      <div className="level-item has-text-centered">
        <div className="is-flex is-flex-direction-column is-align-items-center">
          ...
          <h1>Get City ID</h1>
          <p>The city "verifies" your information <br /> and grants you City ID</p>
        </div>
      </div>
      <div className="level-item has-text-centered">
        <div className="is-flex is-flex-direction-column is-align-items-center">
          ...
          <p>Own your information.<br /> You decide when and with whom you share it.</p>
        </div>
      </div>
      <div className="level-item has-text-centered">
        <div className="is-flex is-flex-direction-column is-align-items-center">
          ...
          <p>As a full-fledged citizen,<br /> enjoy all the perks and benefits.</p>
        </div>
      </div>
    </div>
  )
