    ...
    <section className="section has-background-white">
      <div className="container is-fullhd">
        <div className="is-flex is-flex-direction-column content has-text-centered is-align-items-center">
          ...
          <div className="block">
            <h3>
              You are leaving the <strong>{from}</strong> and will be redirected to the <strong>{to}</strong> website to continue.
            </h3>
          </div>
          <figure className="image is-128x128 wave">
            <img src="https://www.pngrepo.com/png/304508/512/hand-wave-simple.png" alt="" />
          </figure>
          <br /><br />
        </div>
        <div className="block">
